...
func TestQueries(t *testing.T) {
  ...
  [ AND]:
	...
	_testQueryTree(t, `((RECORD.id CONTAINS "1003") AND (RECORD.id CONTAINS DATE("100301")))`,
		`TBD`)
	_testQueryTree(t, `((RECORD.id CONTAINS "1003") AND (RECORD.id CONTAINS DATE("100301")) OR (RECORD.id CONTAINS "2003"))`,
		`TBD`)
	_testQueryTree(t, `((RECORD.id CONTAINS DATE("1003")) AND (RECORD.id CONTAINS DATE("100301")))`,
		`TBD`)
	_testQueryTree(t, `((RECORD.id CONTAINS DATE("1003")) AND (RECORD.id CONTAINS DATE("100301")) AND (RECORD.id CONTAINS DATE("200301")))`,
		`TBD`)
	_testQueryTree(t, `((RECORD.id CONTAINS "1003") AND (RECORD.id CONTAINS "100301"))`,
		`TBD`)
	_testQueryTree(t, `((RECORD.id CONTAINS TIME("1003")) AND (RECORD.id CONTAINS TIME("100301")))`,
		`TBD`)
}
