...
// test optimizator
func testOptimizatorProcess(t *testing.T, o *Optimizator, data string, optimized string) {
...
func testOptimizatorLimits(t *testing.T, limit int, data string, optimized string) {
	...
	testOptimizatorProcess(t, o, data, optimized)
}
