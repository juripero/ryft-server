...
func TestOptimizatorProcess(t *testing.T) {
	...
	testOptimizatorProcess(t, o, true,
		`((RECORD.id CONTAINS DATE(DD/MM/YYYY != 00/00/0000))AND(RECORD.id CONTAINS DATE(DD/MM/YYYY != 00/00/0001))OR(RECORD.id CONTAINS TIME("200301")))`,
		`OR{(RECORD.id CONTAINS DATE(DD/MM/YYYY != 00/00/0000)) AND (RECORD.id CONTAINS DATE(DD/MM/YYYY != 00/00/0001))[ds], (RECORD.id CONTAINS TIME("200301"))[ts]}`)
	...
	testOptimizatorProcess(t, o, true,
		`(RECORD.id CONTAINS "1003")AND(RECORD.date CONTAINS DATE(DD/MM/YYYY != 00/00/0000))AND(RECORD.date CONTAINS TIME("00:00:00"))`,
		`AND{(RECORD.id CONTAINS "1003")[es], (RECORD.date CONTAINS DATE(DD/MM/YYYY != 00/00/0000))[ds], (RECORD.date CONTAINS TIME("00:00:00"))[ts]}`)

	testOptimizatorProcess(t, o, true,
		`(RECORD.id CONTAINS "1003")AND(RECORD.date CONTAINS DATE(DD/MM/YYYY != 00/00/0000))OR(RECORD.date CONTAINS TIME("00:00:00"))`,
		`OR{AND{(RECORD.id CONTAINS "1003")[es], (RECORD.date CONTAINS DATE(DD/MM/YYYY != 00/00/0000))[ds]}, (RECORD.date CONTAINS TIME("00:00:00"))[ts]}`)
	...
	testOptimizatorProcess(t, o, true,
		`((RECORD.id CONTAINS TIME("1003")) AND (RECORD.id CONTAINS TIME("100301")) AND (RECORD.id CONTAINS DATE(DD/MM/YYYY != 00/00/0000)) AND (RECORD.id CONTAINS DATE(DD/MM/YYYY != 00/00/0001)))`,
		`AND{(RECORD.id CONTAINS TIME("1003")) AND (RECORD.id CONTAINS TIME("100301"))[ts], (RECORD.id CONTAINS DATE(DD/MM/YYYY != 00/00/0000)) AND (RECORD.id CONTAINS DATE(DD/MM/YYYY != 00/00/0001))[ds]}`)
