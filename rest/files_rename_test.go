...
func TestRenameFiles(t *testing.T) {
	...
	check("/rename?file=1.txt&new=2.txt", "", "", "", 0, http.StatusOK, `[{"details":{"1.txt":"OK"},"hostname":"`+hostname+`"}]`)
	check("/rename/foo?file=a.txt&new=b.txt", "", "", "", 0, http.StatusOK, `[{"details":{"/foo/a.txt":"OK"},"hostname":"`+hostname+`"}]`)
	check("/rename/foo?file=b.txt&new=../b.txt", "", "", "", 0, http.StatusOK, `[{"details":{"/foo/b.txt":"OK"},"hostname":"`+hostname+`"}]`)
	check("/rename?file=3.txt&new=/../../var/data/3.txt", "", "", "", 0, http.StatusBadRequest, `path \"/var/data/3.txt\" is not relative to home`)
	// directory
	check("/rename?dir=/foo&new=/bar", "", "", "", 0, http.StatusOK, `[{"details":{"/foo":"OK"},"hostname":"`+hostname+`"}]`)
	check("/rename?dir=/foo&new=/../../var/data/bar", "", "", "", 0, http.StatusBadRequest, `path \"/../../var/data/bar\" is not relative to home`)
	check("/rename/bar?dir=/&new=../bar2", "", "", "", 0, http.StatusOK, `[{"details":{"/bar":"OK"},"hostname":"`+hostname+`"}]`)
	// catalog and file
	check("/rename?catalog=/foo.txt&new=/bar.txt", "", "", "", 0, http.StatusOK, `failed to move catalog data`, `no such file or directory`)
	check("/rename?catalog=/catalog.test&file=notexistfile.txt&new=2.txt", "", "", "", 0, http.StatusOK, `[{"details":{"notexistfile.txt":"file '2.txt' already exists"},"hostname":"`+hostname+`"}]`)
	check("/rename?catalog=/catalog.test&file=notexistfile.txt&new=100.txt", "", "", "", 0, http.StatusOK, `[{"details":{"notexistfile.txt":"OK"},"hostname":"`+hostname+`"}]`)
	check("/rename?catalog=/catalog.test&new=/catalog.test2", "", "", "", 0, http.StatusBadRequest, `changing catalog extention is not allowed`)
	check("/rename?catalog=/catalog.test&new=/bar2/catalog.test", "", "", "", 0, http.StatusOK, `[{"details":{"/catalog.test":"OK"},"hostname":"`+hostname+`"}]`)
	...
	check("/rename/bar2?catalog=catalog.test&new=catalog2.test", "", "", "", 0, http.StatusOK, `[{"details":{"/bar2/catalog.test":"OK"},"hostname":"`+hostname+`"}]`)
	check("/rename?catalog=/bar2/catalog2.test2&file=1.txt&new=4.txt", "", "", "", 0, http.StatusOK, `[{"details":{"1.txt":"OK"},"hostname":"`+hostname+`"}]`)
	check("/rename/bar2?catalog=catalog2.test2&file=4.txt&new=1.txt", "", "", "", 0, http.StatusOK, `[{"details":{"4.txt":"OK"},"hostname":"`+hostname+`"}]`)
}
