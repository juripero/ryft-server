...
Ryft Ryft server will split this expression into two separate queries:
...
+| *index* | string | GET /search?query={QUERY}&files={FILE}&format=xml&data={indexFile} | Name of results index file to keep. WARNING: file will be overriden! |
