...
func swaggerJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "swagger.json", size: 12990, mode: os.FileMode(436), modTime: time.Unix(1454356990, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
